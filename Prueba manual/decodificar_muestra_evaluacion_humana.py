...
with open("muestra_para_revision_humana.json", "r", encoding="utf-8") as file:
    data = json.load(file)
...
with open("muestra_para_revision_humana_decodificado.json", "w", encoding="utf-8") as file:
    json.dump(new_data, file, indent=4, ensure_ascii=False)

print("Archivo 'muestra_para_revision_humana.json' generado exitosamente.")